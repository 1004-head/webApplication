...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
   ...
   $customer->University = $_POST['university'];
...
<form class="form-horizontal" role="form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
  ...
  <div class="form-group">
    ...
    <div class="col-md-4">
      <input type="text" class="form-control" name="firstname" value="<?php echo utf8_encode($requestedCustomer->FirstName); ?>" >
    </div>
  </div>  
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-md-8">
      <input type="email" class="form-control" name="email" value="<?php echo $requestedCustomer->Email; ?>"  >
    </div>
  </div>  
  <div class="form-group">
    <label for="university" class="col-md-3 control-label">University</label>
    <div class="col-md-8">
      <input type="text" class="form-control" name="university" value="<?php echo $requestedCustomer->University; ?>"  >
    </div>
  </div>   
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-md-2">
      <input type="text" class="form-control" name="postal" value="<?php echo $requestedCustomer->Postal; ?>"  >
    </div>
  </div>   
  <div class="form-group">
    ...
    <div class="col-md-3">
      <input type="tel" class="form-control" name="phone" value="<?php echo $requestedCustomer->Phone; ?>"  >
    </div>
  </div>  
